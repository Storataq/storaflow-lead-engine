...
export const metadata: Metadata = { title: REVENUE_UI.historyTitle };
...
export default async function RevenueHistoryPage() {
  ...
  const events = await listRevenueHistory(context.organization.id);

  return (
    <div className="space-y-6">
      <PageHeader
        title={REVENUE_UI.historyTitle}
        description="Analyses, forecasts, scenarios, reports — audit trail."
      />
      <Card>
        <CardHeader>

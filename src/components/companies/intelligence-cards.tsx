...
export function CompanyHealthCard({
  ...
  return (
    <AiScoreCard
      ...
      subtitle="Weighted website, contacts, social, completeness, reviews, maturity"
    />
  );
}

export function LeadPotentialCard({
  score,
  temperature,
}: {
  score: number | null;
  ...
  return (
    <AiScoreCard
      ...
      score={score}
      badge={temperature ? LEAD_TEMPERATURE_LABELS[temperature] : null}
      subtitle="AI lead score for outreach prioritization"
    />
  );
}
